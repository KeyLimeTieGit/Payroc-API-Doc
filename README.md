# Payroc OpenAPI Specification
[![Build Status](https://travis-ci.org/KeyLimeTieGit/Payroc-API-Doc.svg?branch=master)](https://travis-ci.org/KeyLimeTieGit/Payroc-API-Doc)
...
6. If you did everything correct, https://keylimetiegit.github.io/Payroc-API-Doc/ will lead to your new docs
...
- Documentation(ReDoc): https://keylimetiegit.github.io/Payroc-API-Doc/
- SwaggerUI: https://keylimetiegit.github.io/Payroc-API-Doc/swagger-ui/
- Look full spec:
    + JSON https://keylimetiegit.github.io/Payroc-API-Doc/swagger.json
    + YAML https://keylimetiegit.github.io/Payroc-API-Doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://keylimetiegit.github.io/Payroc-API-Doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://keylimetiegit.github.io/Payroc-API-Doc/ with url from the message: `Server started <url>`
